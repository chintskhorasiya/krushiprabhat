...
################################################################
//Folder Constant
define("SITE_NAME","Krushi Prabhat");
define("ADMIN_HEADER_TITLE","Krushi Prabhat Administrator");
define("SITE_FOLDER","cakephp/krushiprabhat");
...
if(!defined("DEFAULT_FRONT_EPAPERS_URL")) define("DEFAULT_FRONT_EPAPERS_URL", DEFAULT_URL.'epapers/');
if(!defined("DEFAULT_FRONT_EPAPERS_NZ_URL")) define("DEFAULT_FRONT_EPAPERS_NZ_URL", DEFAULT_URL.'epapers-listing/nz');
if(!defined("DEFAULT_FRONT_EPAPERS_AUS_URL")) define("DEFAULT_FRONT_EPAPERS_AUS_URL", DEFAULT_URL.'epapers-listing/aus');
if(!defined("DEFAULT_FRONT_EPAPERS_NZ_IMG_URL")) define("DEFAULT_FRONT_EPAPERS_NZ_IMG_URL", DEFAULT_URL.'img/new-zealand.jpg');
if(!defined("DEFAULT_FRONT_EPAPERS_AUS_IMG_URL")) define("DEFAULT_FRONT_EPAPERS_AUS_IMG_URL", DEFAULT_URL.'img/australia.jpg');
...
//Site constant
define("SITE_TITLE",'Krushi Prabhat');
define("SITE_EMAIL","projectdesk@seawindsolution.com");

//Email configuration
define("SITE_TEAM","Krushi Prabhat Team ");
