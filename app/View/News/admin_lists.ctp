                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of news created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add News',
                                ...
                                echo $this->Form->create('newsSearch', array('url' => array('controller' => 'news', 'action' => 'search')));
                                ...
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected News">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="news_checks[]" value ="<?php echo $news[$i]['News']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $news[$i]['News']['created']?>
                                                </td>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'news/edit/newsId:'.$news[$i]['News']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'news/delete/newsId:'.$news[$i]['News']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
