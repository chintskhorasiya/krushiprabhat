                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of polls created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Poll',
                                ...
                                if(isset($polls_data) && count($polls_data)>0) 
                                {
                                ?>

                                <?php
                                
                                echo $this->Form->create('pollSearch', array('url' => array('controller' => 'polls', 'action' => 'search')));
                                echo '<div class="search-bar">';
                                echo $this->Form->input('searchtitle', array('label'=>'Search Question or Answer','class' => 'form-control input-lg', 'value'=>$search_key));
                                echo $this->Form->submit('Search');
                                echo '</div>';
                                echo $this->Form->end();

                                echo $this->Form->create('pollList',array('url' => array('controller' => 'polls', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Polls">
                                ...
                                <table class="display table table-bordered table-striped" id="dynamic-table">
                                    ...
                                    <tbody>
                                        <?php
                                            for($i=0;$i<count($polls_data);$i++)
                                            {
                                            ?>
                                            <tr class="gradeA">
                                                
                                                <td>
                                                	<input type="checkbox" name="polls_checks[]" value ="<?php echo $polls_data[$i]['Poll']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $polls_data[$i]['Poll']['created']?>
                                                </td>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'polls/edit/pollId:'.$polls_data[$i]['Poll']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'polls/delete/pollId:'.$polls_data[$i]['Poll']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
