                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Edit Poll</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    <?php
                                    echo $this->Form->create('Poll', array('novalidate', 'type'=>'file'));

                                    echo $this->Form->input('question', array('class' => 'form-control input-lg', 'value' => $polls_data['Poll']['question']));

                                    echo $this->Form->input('answer1', array('label'=>'Answer 1', 'class' => 'form-control input-lg', 'value' => $polls_data['Poll']['answer1']));

                                    echo $this->Form->input('answer2', array('label'=>'Answer 2','class' => 'form-control input-lg', 'value' => $polls_data['Poll']['answer2']));
                                    ...
                                    echo $this->Html->link('Cancel', DEFAULT_ADMINURL.'polls/lists', array('class' => 'btn btn-info'));
                                    ?>
                                    </div>
                                </div>
                            </div>
